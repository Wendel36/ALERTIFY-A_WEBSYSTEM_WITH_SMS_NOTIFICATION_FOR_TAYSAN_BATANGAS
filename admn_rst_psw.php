        ...
        <div class="logo">
            ...
            <h2>Taysan Municipality</h2>
                ...
                <form action="alertify_backend.php" method="post">
                    ...
                    <br>
                    <button class="login_btn" name="admn_rst_btn" style="font-weight: 150px;">Update</button>
                </form><br>
        <div class="text-center fs-6">
            <a href="admn_vrfy_psw.php"><button type="button" class="btn btn-danger" style="font-weight: 100;">Back</button></a>      
        </div>
    </div>
</center>
