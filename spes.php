        ...
        <div class="container1 container1-expand-lg .bg-warning.bg-gradient" style="height: 700px;">
            <div class="input-group">
                <div class="form-outline" >
                  <img src="images\spes.png" style="width: 250px; height: 250px; margin-left: -690px; margin-right: 20px; margin-top: 100px;">
                    <p style="text-align: center; margin-left: 300px; margin-top: -350px; font-size: 40px;">Special Program for the Employment of Students </p>
                    <div class="overflow-auto p-3 bg-light rounded" id="requirements" style="float: right; width: 700px; height: auto; background-color: gray; margin-right: -95px; text-align: left;">
                      ...
                      <img src="images\spesreq.png" style="width: 650px; height: 300px;">
                       <img src="images\spes2.png" style="width: 650px; height: 300px;">
                       <img src="images\spes3.png" style="width: 650px; height: 300px;">
                       <img src="images\spes4.png" style="width: 650px; height: 300px;">
                  </div>
