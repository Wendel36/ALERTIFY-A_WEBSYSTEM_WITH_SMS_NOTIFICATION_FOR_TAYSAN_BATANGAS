        ...
        <div class="container1 container1-expand-lg .bg-warning.bg-gradient" style="height: 700px;">
            <div class="input-group">
                <div class="form-outline" >
                  <img src="images\DSWD.png" style="width: 250px; height: 250px; margin-left: -720px; margin-right: 20px; margin-top: 100px;">
                    <p style="text-align: center; margin-left: 300px; margin-top: -350px; font-size: 40px;">Department of Social Welfare and Development</p>
                    <div class="overflow-auto p-3 bg-light rounded" id="requirements" style="float: right; width: 700px; height: auto; background-color: gray; margin-right: -50px; text-align: left;">
                      <center><h1>Requirements and Procedures</h1></center>
                      <img src="images\dswd1.png" style="width: 650px; height: 300px;">
                      <img src="images\dswd2.png" style="width: 650px; height: 300px;">
                      <img src="images\dswd3.png" style="width: 650px; height: 150px;">
                    </div>
