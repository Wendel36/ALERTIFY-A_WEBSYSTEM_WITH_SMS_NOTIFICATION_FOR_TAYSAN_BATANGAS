        ...
        <div class="container1 container1-expand-lg .bg-warning.bg-gradient" style="height: 700px;">
            <div class="input-group">
                <div class="form-outline" >
                  <img src="images\batelec.png" style="width: 250px; height: 250px; margin-left: -690px; margin-right: 20px; margin-top: 100px;">
                    <p style="text-align: center; margin-left: 300px; margin-top: -350px; font-size: 40px;">Batangas II Electric Cooperative</p>
                    <div class="overflow-auto p-3 bg-light rounded" id="requirements" style="float: right; width: 700px; max-height: 650px; background-color: gray; margin-right: -95px; text-align: left;">
                    <iframe></iframe>
                  </div>
                  <div class="overflow-auto p-3 bg-light rounded" id="payment" style="float: right; width: 700px; height: auto; background-color: gray; margin-right: -95px; display: none; text-align: justify;">
                   <iframe></iframe>
                    </div>
              
                
                  <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white" style="margin-top: 350px; margin-left: -70px; width: 280px;">
                    <div class="position-sticky">
                      <div class="list-group list-group-flush mx-3 mt-4">
                        <button class="list-group-item list-group-item-action py-2 ripple "aria-current="true" onclick="Show1()"><span>Requirements to apply in BATELEC II</span></button>
                        <button class="list-group-item list-group-item-action py-2 ripple " onclick="Show2()"><span>Process of Payment</span></button>
                      </div>
                    </div>
                  </nav>
                </div>
...
<!-- Remove the container if you want to extend the Footer to full width. -->
  ...
  <br>
  <br>
  <table class="table" style="font-size: 14px; float: right; margin-top: 60px; margin-right: 250px; color: white;">
                      <tr>
                        <td >BDRMMC</td>
                        <td >09171102500</td>
                      </tr>
        ...
        <table class="table" style="font-size: 14px; float: right; margin-top: -380px; color: white; ">
                      <tr >
