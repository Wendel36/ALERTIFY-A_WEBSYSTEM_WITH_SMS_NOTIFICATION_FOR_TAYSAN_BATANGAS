...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="container1 container1-expand-lg "style="background-color:#808080; margin-bottom: -47px;">
        <br>
        ...
        <div class="container1 container1-expand-lg .bg-warning.bg-gradient" style="height: 700px;">
            <div class="input-group">
                <div class="form-outline" >
                  <img src="images\gsis.png" style="width: 250px; height: 250px; margin-left: -670px; margin-right: 20px; margin-top: 100px;">
                    <p style="text-align: center; margin-left: 300px; margin-top: -350px; font-size: 40px;">Government Service Insurance System</p>
                    <div class="overflow-auto p-3 bg-light rounded" id="requirements" style="float: right; width: 700px; height: auto; background-color: gray; margin-right: -95px; text-align: left;">
                      ...
                      <img src="images\gsis1.png" style="width: 650px; height: 110px;">
                      <img src="images\gsis2.png" style="width: 650px; height: 300px;">
                      <img src="images\gsis3.png" style="width: 650px; height: 300px;">
                  </div>
