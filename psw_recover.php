            ...
            <div class="text-center mt-4 name"> 
               ...
               <h3>Forgot Password</h3>
                ...
                <form action="alertify_backend.php" method="post">
                    ...
                    <br>
                    <button class="login_btn" name="recover" style="font-weight: 100;">Next</button>
                    <br>
                </form><br>
        <div class="text-center fs-6">
        <a href="login.php"><button type="button" class="btn btn-danger" style="font-weight: 100;">Back</button></a>      
        </div>
    </div>
</center>
