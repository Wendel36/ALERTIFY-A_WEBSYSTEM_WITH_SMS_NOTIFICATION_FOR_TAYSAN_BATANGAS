        ...
        <div class="container1 container1-expand-lg .bg-warning.bg-gradient" style="height: 700px;">
            <div class="input-group">
                <div class="form-outline" ><br><br>
                  <img src="images\psa.png" style="width: 350px; height: 220px; margin-left: -670px; margin-right: 20px; margin-top: 100px;">
                    <p style="text-align: center; margin-left: 200px; margin-top: -350px; font-size: 50px;">Philippine Statistics Authority</p>
                    <div class="overflow-auto p-3 bg-light rounded" id="requirements" style="float: right; width: 700px; height: auto; background-color: gray; margin-right: -100px; text-align: left;">
                      <h1 class="text-center">Requirements and Procedures</h1>
                      <img src="images\psa1.png" style="width: 650px; height: 300px; ">
                      <img src="images\psa2.png" style="width: 650px; height: 300px; ">
                      <img src="images\psa3.png" style="width: 650px; height: 300px; ">
                      <img src="images\psa4.png" style="width: 650px; height: 300px;">
                  </div>
