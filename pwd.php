        ...
        <div class="container1 container1-expand-lg .bg-warning.bg-gradient" style="height: 700px;">
            <div class="input-group">
                <div class="form-outline" >
                  <img src="images\pwd.png" style="width: 350px; height: 350px; margin-left: -650px; margin-right: 20px; margin-top: 150px;">
                    <p style="text-align: center; margin-left: 300px; margin-top: -480px; font-size: 50px;">Person with Disabilities</p>
                    <div class="overflow-auto p-3 bg-light rounded" id="requirements" style="float: right; width: 700px; height: auto; background-color: gray; margin-right: -150px; text-align: left;">
                      <center><h1>Requirements and Procedures</h1></center>
                      <img src="images\medicalcert1.png" style="width: 650px; height: 300px;">
                      <img src="images\medicalcert2.png" style="width: 650px; height: 300px;">
                      <img src="images\medicalcert3.png" style="width: 650px; height: 300px;">
                  </div>
