        ...
        <div class="container1 container1-expand-lg .bg-warning.bg-gradient" style="height: 700px;">
            <div class="input-group">
                <div class="form-outline" >
                  <img src="images\comelec.png" style="width: 250px; height: 250px; margin-left: -590px; margin-right: 20px; margin-top: 100px;">
                    <p style="text-align: center; margin-left: 200px; margin-top: -350px; font-size: 50px;">Commission on Elections</p>
                    <div class="overflow-auto p-3 bg-light rounded" id="requirements" style="float: right; width: 700px; height: auto; background-color: gray; margin-right: -225px; text-align: left;">
                     <iframe></iframe>
                  </div>
                  <div class="overflow-auto p-3 bg-light rounded" id="skrequirements" style="float: right; width: 700px; height: 650px; background-color: gray; margin-right: -225px; display: none; text-align: justify;">
                    <iframe></iframe>
                    </div>
                <div class="overflow-auto p-3 bg-light rounded" id="change" style="float: right; width: 700px; height: auto; background-color: gray; margin-right: -225px; display: none; text-align: justify;">
                   <iframe></iframe>
                </div>
                  <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white" style="margin-top: 350px; margin-left: -100px; width: 280px;">
                    <div class="position-sticky">
                      <div class="list-group list-group-flush mx-3 mt-4">
                        <button class="list-group-item list-group-item-action py-2 ripple "aria-current="true" onclick="Show1()"><span>Requirements to register(Presidential)</span></button>
                        <button class="list-group-item list-group-item-action py-2 ripple " onclick="Show2()"><span>Requirements to register(SK Election)</span></button>
                        <button class="list-group-item list-group-item-action py-2 ripple " onclick="Show3()"><span>Changing of residency(requirements and procedures)</span></button>
                      </div>
                    </div>
                  </nav>
                </div>
...
<script type="text/javascript">
  function Show1(){
    ...
    document.getElementById('skrequirements').style.display = "none";
    document.getElementById('change').style.display = "none";
  }
  function Show2(){
    document.getElementById('requirements').style.display = "none";
    document.getElementById('skrequirements').style.display = "block";
    document.getElementById('change').style.display = "none";
  }  
  function Show3(){
    document.getElementById('requirements').style.display = "none";
