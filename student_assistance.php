        ...
        <div class="container1 container1-expand-lg .bg-warning.bg-gradient" style="height: 700px;">
            <div class="input-group">
                <div class="form-outline" >
                  <img src="images\scholarship.png" style="width: 250px; height: 250px; margin-left: -590px; margin-right: 20px; margin-top: 100px;">
                    <p style="text-align: center; margin-left: 320px; margin-top: -350px; font-size: 50px;">Student Assistance</p>
                    <div class="overflow-auto p-3 bg-light rounded" id="requirements_newstudent" style="float: right; width: 700px; height: auto; background-color: gray; margin-right: -220px;">
                      <center><h1>Requirements and Procedures</h1></center>
                      <img src="images\taysanscholar.png" style="width: 650px; height: 300px;">
                      <img src="images\taysanscholar2.png" style="width: 650px; height: 300px;">
                  </div>
                </div>
                <br>
              </div>
