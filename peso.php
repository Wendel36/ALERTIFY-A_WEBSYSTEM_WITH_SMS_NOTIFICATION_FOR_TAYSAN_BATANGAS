        ...
        <div class="container1 container1-expand-lg .bg-warning.bg-gradient" style="height: 700px;">
            <div class="input-group">
                <div class="form-outline" >
                  <img src="images\peso.png" style="width: 320px; height: 300px; margin-left: -700px; margin-right: 20px; margin-top: 80px;">
                    <p style="text-align: center; margin-left: 300px; margin-top: -350px; font-size: 40px;">Public Employment Service Office</p>
                    <div class="overflow-auto p-3 bg-light rounded" id="requirements" style="float: right; width: 700px; height: auto; background-color: gray; margin-right: -100px; text-align: left;">
                      ...
                      <img src="images\peso1.png" style="width: 650px; height: 300px;">
                      <img src="images\peso2.png" style="width: 650px; height: 200px;">
                    </div>
