        ...
        <div class="container1 container1-expand-lg .bg-warning.bg-gradient" style="height: 700px;">
            <div class="input-group">
                <div class="form-outline" >
                  <img src="images\senior.png" style="width: 250px; height: 250px; margin-left: -500px; margin-right: 20px; margin-top: 100px;">
                    <p style="text-align: center; margin-left: 300px; margin-top: -350px; font-size: 50px;">Senior Citizens</p>
                    <div class="overflow-auto p-3 bg-light rounded" id="requirements" style="float: right; width: 700px; height: auto; background-color: gray; margin-right: -320px; text-align: left;">
                      <center><h1>Requirements and Procedures</h1></center>
                      <img src="images\senior1.png" style="width: 650px; height: 300px;">
                      <img src="images\senior2.png" style="width: 650px; height: 300px;">
                  </div>
