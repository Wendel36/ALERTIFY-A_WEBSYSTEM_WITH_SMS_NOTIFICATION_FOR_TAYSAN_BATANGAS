        ...
        <div class="container1 container1-expand-lg .bg-warning.bg-gradient" style="height: 700px;">
            <div class="input-group">
                <div class="form-outline" >
                  <img src="images\pleb.png" style="width: 350px; height: 250px; margin-left: -700px; margin-right: 20px; margin-top: 100px;">
                    <p style="text-align: center; margin-left: 300px; margin-top: -350px; font-size: 40px;">People's Law Enforcement Board</p>
