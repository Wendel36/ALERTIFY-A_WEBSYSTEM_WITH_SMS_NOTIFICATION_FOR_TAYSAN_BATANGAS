            ...
            <div class="text-center mt-4 name"> 
               ...
               <h3>OTP Verification</h3>
                ...
                <form action="alertify_backend.php" method="post">
                    ...
                    <br>
                    <button class="login_btn" name="admn_vrfy_code" style="font-weight: 100;">Next</button>
                    <br>
                </form><br>
        <div class="text-center fs-6">
            <a href="admn_chnge_psw.php"><button type="button" class="btn btn-danger" style="font-weight: 100;">Back</button></a>      
        </div>
    </div>
</center>
